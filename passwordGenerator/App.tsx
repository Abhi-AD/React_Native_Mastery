...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number()
    ...
    .max(20, 'Should be maximum of 20 characters')
    .required('Enter a Password Length (4-20)'),
});
          ...
          <Formik
            ...
            {({
              ...
              <>
                ...
                <View style={styles.inputWrapper}>
                  <Text style={styles.heading}>Inclue UpperCase letters</Text>
                  <BouncyCheckbox
                    disableBuiltInState
                    isChecked={upperCase}
                ...
                <View style={styles.inputWrapper}>
                  <Text style={styles.heading}>Inclue Numbers</Text>
                  <BouncyCheckbox
                    disableBuiltInState
                    isChecked={numbers}
